                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3">
                    ...
                    <div>
                        <a class="btn btn-ghost"
                            href="{{ route('modul.index', array_filter(['show' => request('show') ? null : 1])) }}">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center text-muted py-4">Belum ada data modul.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
            ...
            <form class="modal-content" method="POST" action="{{ route('modul.store') }}">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input name="nama_modul" class="form-control" required maxlength="100"
                            value="{{ old('nama_modul') }}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Lokasi Modul (slug/route)</label>
                        <input name="lokasi_modul" class="form-control" required maxlength="150"
                            value="{{ old('lokasi_modul') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" name="tglpost" class="form-control" required
                            value="{{ old('tglpost', $nowTz) }}">
                    </div>
                </div>
