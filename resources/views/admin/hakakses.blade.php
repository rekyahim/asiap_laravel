...
@section('content')
  ...
  @push('styles')
  <style>
    :root{ --brand:#5965e8; --brand-2:#7380ff; --ink:#131a29; --border:#eef2f7; }
    ...
    .table thead th{
      ...
      font-weight:600; color:#5d6d8a; font-size:.8rem; text-transform:uppercase; letter-spacing:.5px;
    }
    .table tbody tr{ border-bottom:1px solid var(--border); }
    .table-hover tbody tr:hover{ background:#f9fbff; }
    th.col-aksi { text-align:left; width:360px; }
    ...
    <div class="card shadow-soft">
      ...
      <div class="card-body">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3">
          ...
          <form method="GET" action="{{ route('hakakses.index') }}" class="input-group" style="max-width:360px;">
                ...
                <tr>
                  ...
                  <td class="small text-muted">
                    ...
                    @if ($val)
                      {{
                        (is_numeric($val)
                          ? \Carbon\Carbon::createFromTimestamp((int)$val)
                          : \Carbon\Carbon::parse($val)
                        )->setTimezone($tz)->format('Y-m-d H:i')
                      }} WIB
                    @else - @endif
                  </td>
                  <td class="col-aksi">
