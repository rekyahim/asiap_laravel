        ...
        <div class="card border-0 shadow-sm rounded-4">
            ...
            <div class="card-header bg-white border-0 py-3 px-3">
                <div class="d-flex align-items-center gap-2">
                    <a href="{{ route('dashboard') }}" class="btn btn-sm btn-outline-secondary rounded-3" title="Kembali">
            ...
            <div class="card-body px-3 py-3">
                ...
                <form action="{{ route('profile.change.password.update') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" name="old_password" id="old_password"
                                class="form-control form-control-sm @error('old_password') is-invalid @enderror" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" name="new_password" id="new_password"
                                class="form-control form-control-sm @error('new_password') is-invalid @enderror" required>
                            <button type="button" class="btn btn-outline-secondary btn-sm toggle-password"
                    ...
                    {{-- SUBMIT --}}
                    <button type="submit" class="btn btn-primary btn-sm w-100 fw-semibold rounded-3">
                        Simpan Password
                    </button>
