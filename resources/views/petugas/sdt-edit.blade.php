        ...
        <form id="frmEdit" method="POST"
            ...
            <div class="white-card glass-card mb-3" id="editContainer">
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        if (isset($status->STATUS_PENYAMPAIAN)) {
                            ...
                            } elseif ($status->STATUS_PENYAMPAIAN == '2') {
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="coordDisplay" class="form-control" placeholder="—" disabled
                            value="{{ $status->KOORDINAT_OP ?? '' }}">
                    </div>
                </div>
                ...
                <div class="row g-3 mt-3">
                    <div class="col-md-6">
                        ...
                        if (isset($status->STATUS_OP)) {
                            ...
                            } elseif ($status->STATUS_OP == '2') {
                                $status->STATUS_OP = 'Ditemukan';
                            } elseif ($status->STATUS_OP == '3') {
                                $status->STATUS_OP = 'Tidak Ditemukan';
                            } elseif ($status->STATUS_OP == '4') {
                    ...
                    <div class="col-md-6">
                        ...
                        if (isset($status->STATUS_WP)) {
                            if ($status->STATUS_WP == '1') {
                                $status->STATUS_OP = 'Belum Diproses Petugas';
                            } elseif ($status->STATUS_WP == '2') {
                                $status->STATUS_WP = 'Ditemukan';
                            } elseif ($status->STATUS_WP == '3') {
                                $status->STATUS_WP = 'Tidak Ditemukan';
                            } elseif ($status->STATUS_WP == '4') {
                ...
                <div class="mt-4">
                    ...
                    <div id="expiredMsg" class="mt-3 text-muted"
