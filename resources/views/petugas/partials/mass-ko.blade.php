<!-- ========================= MODAL MASSAL KO ========================= -->
<div class="modal fade" id="modalMassKO" tabindex="-1" aria-hidden="true">
      ...
      <form id="formMassKO" method="POST" action="{{ route('petugas.sdt.massupdate.ko.update') }}">
        ...
        <div class="modal-body px-4 pb-4">
          ...
          <div class="mb-3">
            ...
            <select name="KO" id="selectKO" class="form-select rounded-3" required>
              <option value="">-- Pilih KO --</option>
              @foreach($dataKO as $ko)
                <option value="{{ $ko->ALAMAT_OP }}">{{ $ko->ALAMAT_OP }}</option>
              @endforeach
            </select>
          </div>
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <select name="STATUS" id="STATUS_MASS" class="form-select rounded-3" required>
            ...
            <!-- Status NOP -->
            <div class="col-md-6">
              <label class="form-label fw-semibold">Apakah NOP Benar?</label>
            ...
            <div class="col-md-6 d-none" id="groupStatusOP">
            ...
            <div class="col-md-6 d-none" id="groupStatusWP">
            ...
            <div class="col-12 mt-3">
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <button type="button" id="btnOpenCamKO" class="btn btn-primary btn-sm rounded-3" data-bs-toggle="modal" data-bs-target="#modalCameraKO">Buka Kamera</button>
...
<!-- ========================= MODAL KAMERA KO ========================= -->
<div class="modal fade" id="modalCameraKO" tabindex="-1" aria-hidden="true">
