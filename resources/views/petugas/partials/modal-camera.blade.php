...
<div class="modal fade" id="modalCamera" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
    style="z-index:1065">
    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content camera-modal-content">
            ...
            <div class="camera-footer">
                <button type="button" id="btnCapture" class="camera-capture-btn shadow-lg" disabled></button>
            </div>
